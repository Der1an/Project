...
for i in range(presents_size):
    ...
    id1 = canvas.create_oval(x * snake_item, y * snake_item, x * snake_item + snake_item, y * snake_item,
                             fill=present_color2)
...
def snake_paint_item(canvas, x, y):
    global snake_list
    id1 = canvas.create_rectangle(x * snake_item, y * snake_item, x * snake_item + snake_item, y * snake_item,
                                  fill=snake_color2)
...
def check_if_borders():
    if snake_x > virtual_game_x or snake_x < 0 or snake_x > virtual_game_y or snake_y < 0:
        game_over()
